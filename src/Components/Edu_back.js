            ...
            <div className="plan-container">
                ...
                <div className='px-5 py-4'>
                    <div className="w-100 h-100 edu-box d-flex flex-column">
                        <div className='ms-3'>
                            <div className="position-relative w-auto" style={{left:'-25px', fontSize:'30px'}}>&diams; Before - 2022</div>
                        ...
                        <div className='mt-4 ms-3'>
                            <div className="position-relative w-auto" style={{left:'-25px', fontSize:'30px'}}>&diams; Present</div>
                        ...
                        <div className='mt-4 ms-3'>
                            <div className="position-relative w-auto" style={{left:'-25px', fontSize:'30px'}}>&diams; Free Time</div>
